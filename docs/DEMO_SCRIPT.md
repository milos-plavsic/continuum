...
| 1:35–2:12 | Show three registry candidates. The deterministic gate rejects unsafe choices; Gemini selects v18 from the eligible set with build and health citations. |
| 2:12–2:38 | Show the reconstruction receipt: two verified facts cross; raw injection, a secret, model inference and revoked notes do not. v18 then obtains fresh compliance evidence. |
