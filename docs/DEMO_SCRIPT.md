...
| 1:35–2:12 | Show three registry candidates. The deterministic gate rejects unsafe choices; Gemini selects warm successor v19 from the eligible set with recovery and assurance citations. |
| 2:12–2:38 | Show the reconstruction receipt: two verified facts cross; raw injection, a secret, model inference and revoked notes do not. v19 then obtains policy-admissible official compliance evidence. |
| 2:38–3:02 | The selected-successor transaction checks identity, epoch, policy, compliance, context receipt and idempotency; effect count stays one. |
