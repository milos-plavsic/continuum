...
| Distinct deployed workload identities | `reference-google-cloud` | Cloud Run API plus workload-derived actors | Verified for release `4d676b1`, including separate v18 and v19 successors |
...
| End-to-end Cloud Trace | `reference-google-cloud` | real OTel spans fetched from the Cloud Trace API | Verified: 69 spans under trace `4d9f2269…` |
...
selection and reconstruction receipt—are covered by the exact-commit `4d676b1`
